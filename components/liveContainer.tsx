...
const LiveContainer = () => {
    ...
    return (
        <div className={`fixed left-[20px] bottom-[20px] w-[300px] p-[20px] bg-[#f1f2f6] shadow-xl rounded-[14px] cursor-pointer transition-all hover:scale-[1.02]`} onClick={()=> setTodayLive(!todayLive)}>
