...
const TitleComponent = () => {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col justify-start items-center pt-[200px]">
            ...
            <div className='w-full max-w-[1024px] flex justify-end items-center mt-[40px]'>
            ...
            <div className='w-full max-w-[1024px] flex flex-col justify-start items-center mt-[100px]'>
